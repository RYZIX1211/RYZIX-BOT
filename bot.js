...
const token = 'NTIzMDgxMDAyMDMwMDcxODEw.XMYNTA.R6au5p9LlrJ8YcylHmCaR_iswdU';
const prefix = '/';
 
client.on('ready', () => {
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(` /help | RySystem By Ryzix `,"https://www.twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
.addField("**👑 Created by**",`${message.guild.owner.user.username}#${message.guild.owner.user.discriminator}`)
